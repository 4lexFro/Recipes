...
def home(request):
    ...
    return render(request, 'alexapp/home.html', context)
...
def register(request):
    ...
    return render(request, 'alexapp/registration.html', {'form': form})
...
def user_login(request):
    ...
    return render(request, 'alexapp/login.html')
...
def get_recipe(request, recipe_id):
    ...
    return render(request, 'alexapp/recipe_detail.html', context)
...
def add_recipe(request):
    ...
    return render(request, 'alexapp/add_recipe.html', {'form': form, 'categories': categories})
...
def get_recipe_by_name(request, recipe_name):
    ...
    return render(request, 'alexapp/no_recipe_found.html')
...
def get_recipes(request, user=None):
    ...
    return render(request, 'alexapp/recipe_list.html', context)
...
def search_recipes(request):
    ...
    return render(request, 'alexapp/search_results.html', {'results': results, 'query': query})